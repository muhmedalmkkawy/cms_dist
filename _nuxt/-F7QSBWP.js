import{C as m,$ as v,a2 as S,a6 as p,ae as d,af as O,c as b,o as c,F as B,r as w,g as L,ai as A,w as V,y as K,a as T,E as y,t as I}from"./BoyXQbIz.js";import k from"./7IomI-qk.js";import{s as C}from"./D_8enzW7.js";var D=`
    .p-selectbutton {
        display: inline-flex;
        user-select: none;
...
`,E={root:function(n){var t=n.props,l=n.instance;return["p-selectbutton p-component",{"p-invalid":l.$invalid,"p-selectbutton-fluid":t.fluid}]}},R=m.extend({name:"selectbutton",style:D,classes:E}),$={name:"BaseSelectButton",extends:C,props:{options:Array,optionLabel:null,optionValue:null,optionDisabled:null,multiple:Boolean,allowEmpty:{type:Boolean,default:!0},dataKey:null,ariaLabelledby:{type:String,default:null},size:{type:String,default:null},fluid:{type:Boolean,default:null}},style:R,provide:function(){return{$pcSelectButton:this,$parentInstance:this}}};function x(e,n){var t=typeof Symbol<"u"&&e[Symbol.iterator]||e["@@iterator"];if(!t){if(Array.isArray(e)||(t=h(e))||n){t&&(e=t);var l=0,s=function(){};return{s,n:function(){return l>=e.length?{done:!0}:{done:!1,value:e[l++]}},e:function(u){throw u},f:s}}throw new TypeError(`Invalid attempt to iterate non-iterable instance.
